    ...
    return (
        <div className="bg-[#F4F4F7] text-gray-800 transition-colors duration-300 min-h-screen">
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-4">
                <button
                    onClick={() => router.push('/karir')}
                    className="flex items-center gap-2 text-violet-600 hover:text-violet-700 font-medium font-body transition-colors cursor-pointer"
                >
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-sm sticky top-32">
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <button
                                            onClick={handleClick}
                                            className={`w-full px-6 py-4 text-white rounded-xl font-btn transition-colors flex items-center justify-center gap-3 mb-3 cursor-pointer ${buttonClass}`}
                                        >
                                            {icon}
                                            {buttonText}
                                        </button>
                                ...
                                <div className="mt-6 pt-6 border-t border-gray-100">
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="flex-1 p-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors cursor-pointer"
                                        >
                                        ...
                                        <button
                                            ...
                                            className="flex-1 p-2.5 bg-sky-500 hover:bg-sky-600 text-white rounded-lg transition-colors cursor-pointer"
                                        >
                                            <svg className="w-5 h-5 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 p-2.5 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors cursor-pointer"
                                        >
                                            <svg className="w-5 h-5 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                            </svg>
