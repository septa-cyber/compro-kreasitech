...
export default function ContactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const mailtoLink = `mailto:hello@kreasitech.com?subject=${encodeURIComponent(`[${formData.purpose}] ${formData.subject}`)}&body=${encodeURIComponent(`Nama: ${formData.name}\nEmail: ${formData.email}\nTujuan: ${purposeOptions.find(p => p.value === formData.purpose)?.label}\n\nPesan:\n${formData.message}`)}`;
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-sm">
                                ...
                                <div className="space-y-5">
                                    {/* WhatsApp */}
                                    <a 
                                        href="https://wa.me/6281234567890?text=Halo%20Kreasitech%2C%20saya%20ingin%20bertanya"
                                        target="_blank"
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base font-medium text-text-light font-montserrat">+62 812-3456-7890</p>
                                        </div>
                                    </a>

                                    {/* Email */}
                                    <a 
                                        href="mailto:hello@kreasitech.com"
                                        className="flex items-center gap-4 p-4 rounded-xl hover:bg-gray-50 transition-colors group"
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base font-medium text-text-light font-montserrat">hello@kreasitech.com</p>
                                        </div>
                                    </a>
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <p className="text-base font-medium text-text-light font-montserrat">Jakarta, Indonesia</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-sm">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-gray-500 font-montserrat text-sm">Sabtu</span>
                                        <span className="text-text-light font-medium font-montserrat text-sm">09:00 - 14:00 WIB</span>
                                    </div>
                                    <div className="flex justify-between items-center">
                                        <span className="text-gray-500 font-montserrat text-sm">Minggu</span>
                            ...
                            <div className="bg-violet-800 rounded-2xl p-8 shadow-sm">
                                ...
                                <div className="flex gap-3">
                                    <a href="https://linkedin.com/company/kreasitech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors">
                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                        </svg>
                                    </a>
                                    <a href="https://instagram.com/kreasitech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors">
                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <a href="https://twitter.com/kreasitech" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors">
                                        <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
