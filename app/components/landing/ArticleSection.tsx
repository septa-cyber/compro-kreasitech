            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {articles.map((article) => (
                        <div
                            key={article.id}
                            className="bg-white hover:bg-violet-800 flex flex-col rounded-none overflow-hidden group border border-gray-300 hover:border-violet-800 transition-colors duration-300 animate-fade-in-up h-full"
                        >
                            ...
                            <div className="flex-1 p-6 flex flex-col items-start gap-4">
                                <div className="flex items-center gap-4">
                                    <span className="bg-violet-100 text-violet-700 group-hover:bg-white group-hover:text-violet-800 px-3 py-1 text-xs font-semibold font-montserrat tracking-wide transition-colors duration-300 rounded-[4px]">
                                        {article.category}
                                    </span>
                                ...
                                <h3 className="text-lg font-medium font-montserrat text-text-light group-hover:text-white leading-snug transition-colors duration-300 line-clamp-2">
                                    {article.title}
                                </h3>

                                <p className="text-gray-500 group-hover:text-white/90 font-montserrat leading-relaxed text-sm line-clamp-3 transition-colors duration-300">
                                    {article.description}
                                </p>

                                <div className="mt-auto pt-2">
                                    <button className="text-violet-600 group-hover:text-white font-medium font-montserrat transition-colors duration-300 flex items-center gap-2 group/btn text-sm">
                                        Baca Selengkapnya
