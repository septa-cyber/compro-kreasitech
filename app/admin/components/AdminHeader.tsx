            ...
            <div className="flex-1 max-w-xl relative" ref={searchRef}>
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full pl-11 pr-4 py-2.5 bg-[#F4F4F7] border border-gray-200 rounded-lg text-sm font-montserrat text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 transition-all"
                    />
                </div>
