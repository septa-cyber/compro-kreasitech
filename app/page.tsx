    ...
    <div className="bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark font-sans transition-colors duration-300">
      ...
      <section className="py-24 bg-white dark:bg-background-dark">
        <div className="flex flex-col items-center gap-24">
          ...
          <div className="w-full max-w-[1200px] flex flex-wrap border-t border-l border-gray-200 dark:border-gray-800">
            {/* 1. Talent as a Service */}
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                {/* Icon Placeholder or FontAwesome */}
                <i className="far fa-star text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
                Talent as a Service
              </h3>
              <p className="text-sm font-normal font-montserrat text-text-light-muted dark:text-text-dark-muted leading-relaxed group-hover:text-white transition-colors duration-300">
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                <i className="fas fa-mobile-alt text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                <i className="far fa-question-circle text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                <i className="fas fa-pencil-ruler text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
                UI/UX Design
              </h3>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                <i className="fas fa-tasks text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
                QA Testing
              </h3>
            ...
            <div className="w-full md:w-1/2 lg:w-1/3 min-h-[24rem] px-8 pt-8 pb-12 border-b border-r border-gray-200 dark:border-gray-800 flex flex-col justify-start items-start gap-6 hover:bg-primary dark:hover:bg-primary transition-colors duration-300 group">
              <div className="w-12 h-12 relative overflow-hidden flex items-center justify-center">
                <i className="fab fa-wordpress text-primary text-3xl group-hover:text-white transition-colors duration-300"></i>
              </div>
              <h3 className="text-2xl font-medium font-montserrat text-text-light dark:text-white group-hover:text-white transition-colors duration-300">
                WordPress
              </h3>
        ...
        <div className="flex flex-col items-center gap-24 px-4 w-full">
          ...
          <div className="w-full max-w-[1200px] flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-6">
            ...
            <div className="w-full lg:w-[480px] flex flex-col items-center lg:items-start text-center lg:text-left gap-6">
              <div className="text-xs font-normal font-montserrat opacity-90">
                13 Nov 2025
              </div>
              <h3 className="text-3xl font-medium font-montserrat">
                HiTalent
              </h3>
              <p className="text-base font-normal font-montserrat leading-relaxed opacity-90">
              ...
              <button className="px-8 py-4 bg-violet-300 rounded-lg flex justify-center items-center gap-2.5 hover:bg-violet-200 transition-colors">
                <span className="text-violet-800 text-base font-medium font-montserrat">Start Detail</span>
              </button>
            </div>
