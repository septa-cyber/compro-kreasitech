...
const engagementModels = [
    {
        icon: "/assets/images/Icons/scavanger-hunt 1.svg",
        title: "Head Hunting",
    ...
    {
        icon: "/assets/images/Icons/id-card 1.svg",
        title: "Staffing",
    ...
    {
        icon: "/assets/images/Icons/self-growth 1.svg",
    ...
    {
        icon: "/assets/images/Icons/talent 1.svg",
