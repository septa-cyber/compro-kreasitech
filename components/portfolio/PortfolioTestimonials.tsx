...
export default function PortfolioTestimonials() {
    ...
    return (
        <section className="py-16 md:py-24 bg-gray-100 overflow-hidden">
            ...
            <div className="relative group/testimonials-portfolio">
                {/* Navigation Arrows - Using refined BlogHero style */}
                <button 
                    onClick={() => handleManualScroll('left')}
                    className="absolute left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials-portfolio:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
                ...
                <button 
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials-portfolio:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
                        ...
                        {[...testimonialItems, ...testimonialItems].map((item, index) => {
                            ...
                            return (
                                    <div
                                        ...
                                        className="group flex-shrink-0 w-72 md:w-96 flex flex-col justify-start items-start p-6 md:p-8 bg-white hover:bg-violet-800 border border-gray-300 hover:border-violet-800 transition-all duration-300 shadow-sm hover:shadow-xl"
