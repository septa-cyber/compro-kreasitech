        ...
        <section className="py-16 md:py-24 bg-gray-100 overflow-hidden">
            ...
            <div className="relative group/testimonials">
                ...
                <button
                    ...
                    className="absolute left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
                ...
                <button
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
                    ...
                    {[1, 2].map((setIndex) => (
                        ...
                        >
                            {testimonialItems.map((item, index) => {
                                const testimonialText = item.content || item.quote || "";
                                // Lowered to 320 to trigger earlier on narrower mobile cards (13 lines)
                                const needsTruncation = testimonialText.length > 320;

                                return (
                                    <div
                                        key={`testimonial-${setIndex}-${item.id}-${index}`}
                ...
                >
                    ...
                    >
                        ...
                        <div className="font-body-lg text-gray-800 leading-relaxed italic border-l-4 border-violet-600 pl-6 py-2">
                            "{selectedTestimonial.content || selectedTestimonial.quote}"
                        </div>
                    </div>
                </div>
            )}
