        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            <div className="border-t border-gray-200 pt-8 flex items-center justify-between">
                ...
                <button
                    ...
                    className={`flex items-center gap-2 font-body-sm font-medium px-3 py-2 rounded-md transition-colors ${currentPage === 1
                    ...
                    {getVisiblePages().map((page, index) => (
                        typeof page === 'number' ? (
                            <button
                                ...
                                className={`w-10 h-10 rounded-lg font-body-sm font-medium transition-colors ${currentPage === page
                ...
                <button
                    ...
                    className={`flex items-center gap-2 font-body-sm font-medium px-3 py-2 rounded-md transition-colors ${currentPage === totalPages
                        ? 'text-gray-300 cursor-not-allowed'
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                        }`}
                >
