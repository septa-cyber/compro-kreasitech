                    ...
                    <div className="w-full outline outline-[0.5px] outline-offset-[-0.5px] outline-gray-200 inline-flex justify-between items-center flex-wrap content-center">
                        {focusPrograms.map((program, index) => {
                            return (
                                <div
                                    key={index}
                                    className="w-full md:w-1/2 px-8 pt-8 pb-12 bg-white outline outline-[0.5px] outline-offset-[-0.25px] outline-gray-200 inline-flex flex-col justify-center items-center gap-6 hover:bg-violet-800 transition-colors duration-300 group text-center"
                                    style={{ height: '300px' }}
                                >
                                    ...
                                    <h3 className="font-h4 text-text-light group-hover:text-white transition-colors duration-300 text-center">
                                        {program.title}
                                    </h3>
                                    <p className="font-body-sm text-text-light group-hover:text-white transition-colors duration-300 text-center">
                                        {program.description}
                                    </p>
                                </div>
                            );
