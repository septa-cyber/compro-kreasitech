...
export default function HiTalentTestimonials() {
    ...
    return (
        <section className="py-16 md:py-24 bg-gray-100 overflow-hidden">
            ...
            <div className="relative group/testimonials-hitalent">
                {/* Navigation Arrows - Using refined BlogHero style */}
                <button 
                    onClick={() => handleManualScroll('left')}
                    className="absolute left-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials-hitalent:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
                ...
                <button 
                    ...
                    className="absolute right-6 top-1/2 -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full bg-black/40 text-white backdrop-blur-md opacity-0 group-hover/testimonials-hitalent:opacity-100 transition-all duration-300 hover:bg-violet-600 border border-white/10 shadow-xl"
